!function (e, t) {
    ...
    return function () {
        ...
        return function () {
            ...
            var e = n(974), t = n.n(e), r = function (e, t, r) {
                ...
                for (var n, a = [], o = new RegExp("(" + t.map((function (e) {
                    ...
                    var d = e.slice(0, n + t[l].right.length), s = i.test(d) ? d : e.slice(t[l].left.length, n);
                    a.push({
                        type: "math",
                        data: s,
                        rawData: d,
                ...
                for (var a = document.createDocumentFragment(), i = 0; i < n.length; i++) if ("text" === n[i].type) a.appendChild(document.createTextNode(n[i].data)); else {
                    var l = document.createElement("span"), d = n[i].data;
                ...
                for (var n = 0; n < t.childNodes.length; n++) {
                    ...
                    if (3 === a.nodeType) {
                        ...
                        var t = " " + a.className + " ";
                        -1 === r.ignoredTags.indexOf(a.nodeName.toLowerCase()) && r.ignoredClasses.every((function (e) {
                ...
                r.delimiters = r.delimiters || [{left: "$$", right: "$$", display: !0},{left: "$", right: "$", display: !1}, {
                    left: "\\(",
                    right: "\\)",
                    display: !1
